...
public class Window_Graph_Tiegel2 : MonoBehaviour {
    ...
    public void ShowGraph(float value, int sekunden, int tiegelFarbe) //Vorher: ShowGraph(List<int> valueList)
    {
        //if (changedPos == false)
        //{
        //    if (BBSlot[0].GetComponentInChildren<GameObject>().CompareTag("40SiCold"))
        //    {
        //        PanelTiegel.transform.position = new Vector2(-42, -101);
        //        PanelTiegel.layer = 0;
        //    }
        //    else if (BBSlot[1].GetComponentInChildren<GameObject>().CompareTag("40SiCold"))
        //    {
        //        PanelTiegel.transform.position = new Vector2(-42, -231);
        //        PanelTiegel.layer = 0;
        //    }
        //    else if (BBSlot[2].GetComponentInChildren<GameObject>().CompareTag("40SiCold"))
        //    {
        //        PanelTiegel.transform.position = new Vector2(-42, -387);
        //        PanelTiegel.layer = 0;
        //    }
        //    else if (BBSlot[3].GetComponentInChildren<GameObject>().CompareTag("40SiCold"))
        //    {
        ...
        //        PanelTiegel.transform.position = new Vector2(-42, -101);
        //        PanelTiegel.layer = 1;
        //        Debug.Log("Konnte kein Tiegel finden mit dem Tag '40SiCold'");
        //    }
        //    changedPos = true;
        //}
